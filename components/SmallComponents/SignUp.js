    ...
    >
      ...
      <form onSubmit={onSubmit}>
        <div className=" space-y-5 mt-7">
          ...
          />
          <div onClick={signInWithGoogle} className=" cursor-pointer active:scale-95 flex justify-center items-center space-x-2 w-full bg-gray-100 drop-shadow-md font-medium p-3 rounded-xl">
